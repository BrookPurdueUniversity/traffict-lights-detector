...
parser.add_argument('--dir_raw_dataset', type=str, default="C:/Users/Brook/Desktop/Brook_tld/data/carla/train", help='path of Raw Dataset.')
parser.add_argument('--dir_preprocessed_dataset', type=str, default="C:/Users/Brook/Desktop/Brook_tld/data/carla/tmp/train_pre", help='path of Preprocessed Dataset.')
...
parser.add_argument('--dir_checkpoint', type=str, default="C:/Users/Brook/Desktop/Brook_tld/saved_weights", help='place to store and reload checkpoints.')
parser.add_argument('--continue_training', type=str2bool, default=True, help='Whether to continue training from a checkpoint')
parser.add_argument('--model_name', type=str, default='tl_model_detector_carla.json', help='name of saved model in the path of ckpt')
parser.add_argument('--weights_name', type=str, default='tl_weights_detector_carla.h5', help='name of saved weights in the path of ckpt')
args = parser.parse_args(args=[])

dir_npy_imgs = args.dir_preprocessed_dataset + '/tl_IMG.npy'
dir_npy_masks = args.dir_preprocessed_dataset + '/tl_MASK.npy'
ckpt = args.dir_checkpoint

##################### Step 1: Data Preprocessing ##############################
if not os.path.isdir(args.dir_preprocessed_dataset):
   os.makedirs(args.dir_preprocessed_dataset)
   
print('Brook: Preparing .npy dataset. ==================')
combo_npy(args.dir_raw_dataset, args.key, args.dir_preprocessed_dataset)
