...
parser.add_argument('--dir_test_pre', type=str, default="C:/Users/Brook/Desktop/Brook_tld/data/carla/tmp/test_pre", help='path of all Dataset.')
parser.add_argument('--dir_test_images', type=str, default="C:/Users/Brook/Desktop/Brook_tld/data/carla/test", help='path of Testing Dataset.')
parser.add_argument('--dir_results', type=str, default="C:/Users/Brook/Desktop/Brook_tld/data/carla/tmp/test_results", help='path of results for Testing Dataset.')
...
parser.add_argument('--checkpoint_dir', type=str, default="C:/Users/Brook/Desktop/Brook_tld/saved_weights", help='place to store and reload checkpoints.')
...
if not os.path.exists(args.dir_test_pre):
    os.mkdir(args.dir_test_pre)
read_subfolder(args.dir_test_images, args.dir_test_pre)
imgs_files = glob(args.dir_test_pre + '/*.jpg')
